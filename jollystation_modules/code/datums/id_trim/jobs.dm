...
/datum/id_trim/job/bridge_officer
	...
	full_access = list(ACCESS_MEDICAL, ACCESS_ENGINE, ACCESS_BRIG, ACCESS_COURT, ACCESS_ARMORY, ACCESS_SEC_DOORS, ACCESS_SECURITY,
						ACCESS_MAINT_TUNNELS, ACCESS_CONSTRUCTION, ACCESS_MORGUE, ACCESS_CARGO, ACCESS_MAILSORTING,
						ACCESS_RESEARCH, ACCESS_MECH_SECURITY, ACCESS_MINERAL_STOREROOM, ACCESS_HOP, ACCESS_CE, ACCESS_CMO, ACCESS_RD,
